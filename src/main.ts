...
import { populate1965Surfaces, populate2025Surfaces } from './compositions';
...
// The 1965 and 2025 eras dress the shell's surface slots (checkerboard tile
// / geometric wallpaper / plaster ceiling, and white ceramic tile / polished
// concrete / matte black exposed-services ceiling) through their compositions.
// Eras that are not yet composed keep the neutral placeholder finishes; the
// composed finishes are applied on first mount so the visible room matches
// the era.
